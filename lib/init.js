...
module.exports = class Init {
  ...
  async run(argv) {
    this._spinner.info(chalk.yellowBright('Start initializing'))
    ...
    const boilerplatesDir = await this.downloadPkg(this._pkgInfo.config.boilerplates)
    const boilerplateDir = resolve(argv.base || boilerplatesDir || resolve(__dirname, '..'), `boilerplates/${types.type}`)
